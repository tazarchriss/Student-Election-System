  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-info">Change Password</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="row" style="margin:auto;">
            ...
            <div class="col-md-10" style="margin:auto">
              ...
              <div class="card card-info">
                ...
                <!-- form start -->
                <form id="quickForm" method="post" action="config/changepass.php">
                  <div class="card-body ">
                  <?php
                ...
                ?>
                     <input type="text" name="regno" class="form-control" id="exampleInputEmail1" value="<?php echo $_SESSION['regno']; ?>" hidden>
                  ...
                  if (isset($_GET["old"])){
                  ?>
                <p class="text-danger " style="margin-left:20px;">Wrong Old Password!</p>
                  <?php     
                }
