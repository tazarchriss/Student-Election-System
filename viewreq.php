<?php
      ...
      $sql1 = "select * from request WHERE status='pending'";
...
<?php include 'mnavbar.php'; ?>
          ...
          <div class="card card-info">
            ...
            <div class="card-body p-0">
                <?php
                    ...
                    ?>
                    <h3 class="text-center text-info"> No Candidate Requests Available ! </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a href="https://tazarchriss.me">TazarChriss</a>.</strong> All rights reserved.
  </footer>
