        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item navbar-info" style="margin:2px;">
            ...
            <ul class="nav nav-treeview text-white">
              <li class="nav-item">
                <a href="viewreq.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Candidate Requests</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="viewcandidate.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>View Candidates</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="requesthist.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Request History</p>
                </a>
              </li>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="voting.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Election setting</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="estats.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
