        ...
        <div class="row">
            <div class="col-md-12" style="margin:auto;">
                ...
                <div class="card card-info card-outline col-md-10" style="margin:auto;">
                  ...
                  ?>
                    <strong><i class="fas fa-user-tie mr-1"></i> Station Name</strong>
                    ...
                    <hr>
                    <strong><i class="fas fa-poll mr-1"></i> Officer Incharge</strong>
                    ...
                    <strong><i class="far fa-polls mr-1"></i>Votes</strong>
