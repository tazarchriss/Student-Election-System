  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-info">Election Results</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row" >
              ...
              <?php
                    for ($i=1; $i<=mysqli_num_rows($query1); $i++){
                      ...
                      $sql24 = "SELECT * FROM `request` WHERE status='approved' AND position='1' AND regno!='$regno'";
                      $query24 = mysqli_query($conn, $sql24);
                      $row24=mysqli_num_rows($query24);
                      $row12=mysqli_num_rows($query2);
                ...
                <?php 
                        ...
                        $win=mysqli_fetch_array($query24);
                        $reg=$win['regno'];
                        $sdl="Select * from users where regno='$reg'";
                        $det=mysqli_query($conn,$sdl);
                        $user=mysqli_fetch_array($det);
                       
                        $pid=$row24['position'];
                        $sql33 = "select * from position WHERE positionID='$pid'";
                        ...
                        echo "winner";
                         ?>
                         <div class="card card-success bg-light d-flex flex-fill">
                  <div class="card-header text-white border-bottom-0">
                    <h5>NEW PRESIDENT !</h5>
                  </div>
                  <div class="card-body pt-0" style="margin-top:5px;">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 text-left">
                      ...
                      <div class="col-7 text-left">
                        <h2 class="lead text-bold">Name : <b class="text-info"><?php echo $user['fname']. " ". $user['mname']. " ". $user['lname']; ?></b></h2>
                        <h2 class="lead text-bold">School : <b class="text-info"><?php echo $row4['school']; ?></b></h2>
                        <h2 class="lead text-bold">Programme : <b class="text-info"><?php echo $row6['programme']. " " .$row['year']; ?></b></h2>
